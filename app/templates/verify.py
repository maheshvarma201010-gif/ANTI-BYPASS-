VERIFY_PAGE_TEMPLATE = """<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <div id="errorState">
            ...
            <div class="url-box">
                ...
                <code style="color: #28a745;">
                    ?target=ENCODED_TARGET&hash=YOUR_HASH&nonce=NONCE
                </code>
            </div>
    ...
    <script>
        (function() {
            ...
            // Check if navigation was direct / paste (type 0/1 or direct entry without referrer)
            try {
